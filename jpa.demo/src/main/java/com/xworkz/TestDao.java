...
public class TestDao {
	...
	public static void main(String[] args) {
		...
		//Person getPerson=entityManager.find(Person.class, 2);
		//entityManager.remove(getPerson);
		Person updatePerson=entityManager.find(Person.class, 2);
		System.out.println(updatePerson);
		updatePerson.setFirstName("Chaya");
		updatePerson.setLastName("Sumanth");
